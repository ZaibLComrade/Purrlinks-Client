	...
	return <form className="container px-4 mx-auto">   
			...
			<div className="flex items-center justify-center gap-1">
				<div className="relative">
					...
					<input type="search" id="default-search" className="block p-4 text-sm border rounded-lg ps-10 focus:ring-blue-500 focus:border-blue-500 " placeholder="Browse purrs..." required />
