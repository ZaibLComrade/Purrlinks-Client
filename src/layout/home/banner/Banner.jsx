...
export default function Banner() {
	...
	return <div className="relative h-full md:h-[80vh] bg-white bg-cover" style={{ backgroundImage: `url(${bannerImage})` }}>
		{/* Overlay */}
		...
		<div className="relative z-20 flex flex-col flex-col-reverse items-center w-full h-full p-6 md:absolute gap-8 md:flex-row md:p-14">
			<div className="flex flex-col items-center justify-center w-auto text-center md:items-start lg:w-1/2 shrink-0 md:shrink md:text-left gap-4 lg:gap-8">
